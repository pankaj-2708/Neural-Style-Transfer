...
def download_artifacts(encoder_run_id="0179cde372fb4f60bfb93deb104e682f",decoder_run_id="d0c790f0a1fe43fa9218e6b238a1d930"):
...
def load_models(encoder_local_path,decoder_local_path):
    encoder=ort.InferenceSession(
        encoder_local_path+'model.onnx',providers=['CUDAExecutionProvider', 'CPUExecutionProvider']
    )
    decoder=ort.InferenceSession(
        decoder_local_path+'model.onnx',providers=['CUDAExecutionProvider', 'CPUExecutionProvider']
    )
